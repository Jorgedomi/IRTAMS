...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nombre_usuario)) {
       $stmt = $conn->prepare("INSERT INTO usuario (nombre, password, edad, fecha_nacimiento, correo) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("ssiss", $nombre_usuario, $password, $edad, $fecha, $correo);
